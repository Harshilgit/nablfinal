# Generated by Django 3.0.6 on 2021-12-20 18:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('staff_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calibration_management_app.Staffs')),
            ],
        ),
        migrations.CreateModel(
            name='FeedBackStaffs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('job_choices', models.BooleanField(choices=[('LAB NABL', 'LAB NABL'), ('LAB TRAC', 'LAB TRAC'), ('ONSITE NABL', 'ONSITE NABL'), ('ONSITE TRAC', 'ONSITE TRAC')], default='LAB NABL')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('party', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='calibration_management_app.Party')),
            ],
        ),
    ]
